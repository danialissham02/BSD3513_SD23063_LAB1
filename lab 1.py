# ------------------------------------------------------------
# Lab Report 1 BSD3513 – Artificial Intelligence
# Chapter 2: Search Algorithms (BFS & DFS)
# Student Name: MUHAMMAD DANIAL BIN ISSHAM
# Student ID: SD23063
# Section: 02G
# ------------------------------------------------------------
...
st.markdown("Name: MUHAMMAD DANIAL BIN ISSHAM | Student ID: SD23063 | Section: 02G")
...
if img_path is not None:
    try:
        ...
        st.warning(f"⚠ Found '{img_path.name}' but failed to open it. It may be corrupted.")
else:
